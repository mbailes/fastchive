...
class button {
 ...
 public:
  ...
  int draw();
  button();
  button(float xx, float yy, const char * input);
};
...
class check {
 public:
  ...
  int toggle();
  check();
  check(float xx, float yy, const char * input, int status);
};
...
class radio {
 public:
  ...
  int inside(float x, float y);
  radio();
  radio(float xx, float yy, const char * input, int status, int group_input);
};
...
class plotregion {
 public:
  ...
  int erase();
  int insideworld(float x, float y);
};
...
class staticText{
 public:
  ...
  int draw();
  staticText();
  staticText(float xx, float yy, const char * input, int colour, float ss,
	     float o=0.0);
};
...
class dialog {
 ...
 public:
  ...
  int nplotregion;
  int nstaticText;
  int addbutton(float x, float y, const char * label);
  int addradio(float x, float y, const char * label, int c, int s);
  int addcheck(float x, float y, const char * label, int c);
  int addplotregion(float xmin, float xmax, float ymin, float ymax);
  int addstaticText(float x, float y, const char * l, int ci, float size, float o);
